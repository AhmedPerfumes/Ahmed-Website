        ...
        const fetchData = async () => {
            try {
                ...
                if (collectionsCategory) {
                    const givingCollection = collectionsCategory.productSubCategories?.find(sub => sub.id === 34);

                    if (givingCollection && givingCollection.products) {
                        const formattedSlides = givingCollection.products.map(product => {
                            ...
                            if (cleanDescription) {
                                cleanDescription = cleanDescription
                                    .replace(/Eid Al Adha/gi, "Father's Day")
                                    .replace(/Eid Al-Adha/gi, "Father's Day")
                                    .replace(/Eid/gi, "Father's Day")
                                    .replace(/عيد الأضحى/g, "يوم الأب")
                                    .replace(/العيد/g, "يوم الأب")
                                    .substring(0, 150) + "...";
                            }

                            const productSlug = product.product_name
                                ? product.product_name.toLowerCase().replace(/&amp;/g, "and").replace(/[^\w\s-]/g, "").trim().replace(/\s+/g, '-')
                                : product.product_id;

                            return {
                                id: product.product_id,
                                title: isRtl ? (product.product_name_ar || product.product_name) : product.product_name,
                                subtitle: isRtl ? "مجموعة يوم الأب" : "Father's Day Collection",
                                description: cleanDescription,
                                image: `https://admin.ahmedalmaghribi.com/public/storage/${JSON.parse(product.images)[0]}`,
                                link: `/shop/collections/the-essence-of-giving/${productSlug}`
                            };
                        });
        ...
        >
            <Container maxWidth="xl">
                ...
                <Box sx={{ textAlign: "center", mb: 6, position: "relative", zIndex: 2 }}>
                    ...
                    >
                        {isRtl ? "مجموعات يوم الأب" : "Father's Day Collections"}
                    </Typography>
                </Box>
                    ...
                    {slides.map((slide, index) => (
                        <SwiperSlide key={slide.id}>
                            ...
                            >
                                ...
                                {/* Decorative Elements */}
                                <Box sx={{ position: "absolute", top: "30%", right: "8%", width: "150px", height: "150px", border: "2px solid rgba(191, 149, 63, 0.15)", borderRadius: "50%", zIndex: 0 }} />
                                <Box sx={{ position: "absolute", top: "5%", left: "50%", width: "100px", height: "100px", border: "2px solid rgba(191, 149, 63, 0.12)", borderRadius: "50%", zIndex: 0 }} />
                                <Box sx={{ position: "absolute", bottom: "15%", left: "8%", width: "80px", height: "80px", border: "1px solid rgba(191, 149, 63, 0.1)", borderRadius: "50%", zIndex: 0 }} />
                                <Box sx={{ position: "absolute", top: "60%", right: "25%", width: "60px", height: "60px", border: "1px solid rgba(191, 149, 63, 0.08)", borderRadius: "50%", zIndex: 0 }} />
                                <Box sx={{ position: "absolute", top: "20%", left: "20%", width: "120px", height: "120px", border: "1px dashed rgba(191, 149, 63, 0.12)", borderRadius: "50%", zIndex: 0 }} />
                                <Box sx={{ position: "absolute", bottom: "35%", right: "15%", width: "90px", height: "90px", border: "1px dashed rgba(191, 149, 63, 0.1)", borderRadius: "50%", zIndex: 0 }} />
                                <Box sx={{ position: "absolute", top: "15%", right: "20%", width: "8px", height: "8px", background: "#BF953F", borderRadius: "50%", zIndex: 0, opacity: 0.6, boxShadow: "0 0 10px rgba(191, 149, 63, 0.5)" }} />
                                <Box sx={{ position: "absolute", bottom: "25%", left: "30%", width: "6px", height: "6px", background: "#D4AF37", borderRadius: "50%", zIndex: 0, opacity: 0.5, boxShadow: "0 0 8px rgba(212, 175, 55, 0.5)" }} />
                                <Box sx={{ position: "absolute", top: "40%", left: "12%", width: "5px", height: "5px", background: "#BF953F", borderRadius: "50%", zIndex: 0, opacity: 0.4 }} />
                                <Box sx={{ position: "absolute", top: "70%", right: "35%", width: "7px", height: "7px", background: "#D4AF37", borderRadius: "50%", zIndex: 0, opacity: 0.5, boxShadow: "0 0 8px rgba(212, 175, 55, 0.4)" }} />
                            </Box>
                        </SwiperSlide>
                    ))}
                </Swiper>
...
export default FathersDayVideoSlider;
