...
const FathersDaySpecialOffer = () => {
    ...
    useEffect(() => {
        if (!loading && typeof window !== 'undefined' && window.location.hash === '#fathersday-special-offers') {
            const element = document.getElementById('fathersday-special-offers');
            if (element) {
                setTimeout(() => {
                    const offset = 80;
        ...
        >
            <Container maxWidth="xl">
                <Box sx={{ textAlign: "center", mb: { xs: 4, md: 6 } }}>
                    ...
                    >
                        {isArabic ? "عروض يوم الأب الخاصة" : "Father's Day Special Offers"}
                    </Typography>
                    <Box
                        sx={{
...
export default FathersDaySpecialOffer;
