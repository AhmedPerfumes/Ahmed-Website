...
const Animation = () => {
    ...
    useEffect(() => {
        ...
        const updateSnap = () => {
          ...
          const sectionPositions = sectionTriggers.map(trigger => trigger.start / max); // snapping values must be in ratios
          panels.forEach((panel2, i) => sectionPositions.push((start + i * each) / max)); // add panel2 positions
            ...
            <section className="testsect">
                <div className="panel2">
                    ...
                    <div className="text_reveal position-absolute">
                        ...
                        <p className="text-center text-white p">This panel gets pinned in a similar way, and has a more involved animation that's wrapped in a timeline, fading the background color and animating the transforms of the paragraph in addition to the line, all synced with the scroll position perfectly.</p>
                    </div>
                </div>
            </section>
                            ...
                            <div className="main-wrapper swiper-wrapper">
                                <div className="mainnn swiper-slide" id="beach">
                                    <div className="left-sideee">
                                        ...
                                        <div className="mainnn-content">
                                            <div className="mainnn-content__title">In 20 years, there could be more plastic in our oceans than fish.</div>
                                            <div className="mainnn-content__subtitle">Plastic pollution injures more than 100.000 marine animals every year.It takes around 450 years for one plastic bottle to decompose.</div>
                                    ...
                                    <div className="centerrr">
                                        <div className="right-side__img">
                                            ...
                                            <img className="bottle-img" src="https://www.designforfinland.com/product-images/Closca_Bottle_Wave_Antarctica_450ml_Close.png/2083089000004207012/1100x1100" />
                                        </div>
                                    </div>
                                </div>
                                <div className="mainnn swiper-slide" id="savanna">
                                    <div className="left-sideee">
                                        ...
                                        <div className="mainnn-content">
                                            <div className="mainnn-content__title">The Earth’s area affected by desertification is approx 11 times India’s size.
                                            </div>
                                            <div className="mainnn-content__subtitle">The Savannas act as a carbon sink, absorbing CO2 from the atmosphere and helping to maintain the balance of global temperatures.</div>
                                            <div className="moreee-menu">
                                                <Link href="">Shop Now {' '}
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.7" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    ...
                                    <div className="centerrr">
                                        <div className="right-side__img">
                                            ...
                                            <img className="bottle-img" src="https://fnac.sa/cdn/shop/files/Closca_Bottle_Wave_Sahara_600ml_Close.png?v=1703675684" />
                                        </div>
                                    </div>
                                </div>
                                <div className="mainnn swiper-slide" id="glacier">
                                    <div className="left-sideee">
                                        ...
                                        <div className="mainnn-content">
                                            <div className="mainnn-content__title">Glaciers contain 75% of the World's freshwater.
                                            </div>
                                            <div className="mainnn-content__subtitle">The effects of melting ice glaciers are biodiversity loss, the rising of the sea level and the deficiency of freshwater, among others.</div>
                                            <div className="moreee-menu">
                                                <Link href="">Shop Now {' '}
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.7" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    ...
                                    <div className="centerrr">
                                        <div className="right-side__img">
                                            ...
                                            <img className="bottle-img" src="https://gomagcdn.ro/domains/alty.ro/files/product/original/sticla-reutilizabila-apa-closca-glacier-copie-848-7049.png" />
                                        </div>
                                    </div>
                                </div>
                                <div className="mainnn swiper-slide" id="coral">
                                    <div className="left-sideee">
                                        ...
                                        <div className="mainnn-content">
                                            <div className="mainnn-content__title">We will have lost 60% of our coral reefs by 2030.
                                            </div>
                                            <div className="mainnn-content__subtitle">Coral reefs are essential to humans, as they protect the shorelines and are a source of
                                    ...
                                    <div className="centerrr">
                                        <div className="right-side__img">
                                            ...
                                            <img className="bottle-img" src="https://fnac.sa/cdn/shop/files/Closca_Bottle_Wave_Arizona_600ml_Close.png?v=1703675684&width=1946" />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section className="cont testsect">
                <div className="panel2">
                    ...
                    <div className="d-flex flex-column align-items-center justify-content-center">
                        <h3>Carefully <span>selected ingredients</span></h3>
                        <p className='text-center'>From endemic species to renowned terroirs, we are particularly meticulous when it comes to sourcing our raw materials. While respecting the rhythms of nature, we commit to selecting only the highest-quality ingredients, imparting our perfumes with their rich olfactory facets.</p>
                        <div className='mt-5'>
                            <img className='p-2' src="https://www.ateliercologne.com/images/chapters/fourth/stories/first/ingredients_1-Desktop@1x.jpg" alt="Image 1" />
                            <img src="https://www.ateliercologne.com/images/chapters/fourth/stories/first/ingredients_2-Desktop@1x.jpg" alt="Image 2" />
                        </div>
                    </div>
                </div>
                ...
                <div className="panel2">
                    <div className="inner2">
                        <video loop muted autoPlay className="mb-4 pb-4 mb-xl-4 mt-xl-3 pt-xl-3 pb-xl-4">
                ...
                <div className="panel2">
                    ...
                    <div className="inner2">
                        <img className='px-4' src="https://www.ateliercologne.com/images/chapters/fourth/stories/second/visual/into-glass@1x.jpg" alt="video/mp4" />
                        <img src="https://www.ateliercologne.com/images/chapters/fourth/stories/second/visual/into-glass@1x.jpg" alt="video/mp4" />
                    </div>
                </div>
            </section>
            <div className="mb-4 pb-4 mb-xl-4 mt-xl-3 pt-xl-3 pb-xl-4"></div>
