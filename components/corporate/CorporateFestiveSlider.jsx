    ...
    en: {
        ...
        tabs: [
            ...
            // },
            {
                ...
                subtitle: "The most beautiful moments are those shared with faith, family, and heartfelt giving. From Ramadan's peace to Eid's delight, every gift shines with warmth and light.",
                image: "/assets/Corporate Gift Sets/eilduladha.jpeg",
            ...
            },
            {
                ...
                subtitle: "The most beautiful moments are those shared with faith, family, and heartfelt giving. From Ramadan's peace to Eid's delight, every gift shines with warmth and light.",
                image: "/assets/Corporate Gift Sets/christmas2.jpeg",
        ...
        tabs: [
            {
                id: "ramadan",
                title: "رمضان",
                badge: "بركات الشهر الفضيل  ",
                eyebrow:"حيث يلتقي الإيمان بالدفء",
                subtitle: "أجمل اللحظات هي تلك التي تتجلى بالإيمان والعائلة والعطاء الصادق. فمن سكون رمضان إلى بهجة العيد، يشرق كل إهداء بالدفء والنور",
                image: "/assets/Corporate Gift Sets/eilduladha.jpeg",
                icon: <NightlightIcon sx={{ fontSize: "1.2rem" }} />,
                poem: "في ليالٍ من السكون وأيامٍ مباركة، احمل الدفء بنفحاتٍ طاهرة. رمزٌ للإيمان، ونقاءٌ في العطاء، وعبيرٌ يُديم البهجة الهادئة",
            },
            // {
            //     id: "eid-al-fitr",
            //     title: "عيد الفطر",
            ...
            // },
            {
                ...
                title: "عيد الأضحى",
                badge: "تقاليد مقدسة",
                eyebrow: "حيث تتواصل التقاليد",
                subtitle: "أجمل اللحظات هي تلك التي تتجلى بالإيمان والعائلة والعطاء الصادق. فمن سكون رمضان إلى بهجة العيد، يشرق كل إهداء بالدفء والنور",
                image: "/assets/Corporate Gift Sets/corporate gift set black square 01.jpg.jpeg",
                icon: <MosquesIcon sx={{ fontSize: "1.2rem" }} />,
                poem: "إجلالاً للتضحية وتشاركاً للفضل، وتجسيداً للفرحة في كل عناق دافئ. إهداءٌ من التوقير فاخرٌ وجليل، وبركاتٌ تفيض في أرجاء البلاد",
            },
            {
                id: "diwali",
                title: "ديوالي",
                badge: "احتفالات الأعياد",
                eyebrow: "حيث يلهم النور الفرح",
                subtitle: "أنر كل رابطة بجوهر ديوالي. صُممت بعناية للتعبير عن الامتنان وصنع لحظات لا تُنسى مع العملاء والموظفين والأصدقاء. كل عطر هو رمز للدفء والبدايات الجديدة",
                 image: "/assets/Corporate Gift Sets/Diwali.jpeg",
                icon: <CelebrationIcon sx={{ fontSize: "1.2rem" }} />,
                poem: "كما تضيء المصابيح السماء وتتوهج القلوب نوراً، ليحمل هذا العطر ضياء ديوالي. هدية من الفرح، وذكرى آسرة، حيث تتعانق كل رابطة وكل بركة.",
            },
            {
                id: "christmas",
                title: "الكريسماس",
                badge: "أطيب التمنيات في موسم الأعياد",
                eyebrow: "حيث يجمعنا الدفء",
                subtitle: "أجمل اللحظات هي تلك التي تتجلى بالإيمان والعائلة والعطاء الصادق. فمن سكون رمضان إلى بهجة العيد، يشرق كل إهداء بالدفء والنور.",
                image: "/assets/Corporate Gift Sets/christmas2.jpeg",
                icon: <ChurchIcon sx={{ fontSize: "1.2rem" }} />,
                poem: "تتحت أضواء الشتاء وبهجة الأعياد، غلّف حبك لمن هم أعزّ على قلبك. ذكريات ذهبية وأناقة خالدة تنشر الدفء في كل مكان.",
            },
        ],
    },
};
