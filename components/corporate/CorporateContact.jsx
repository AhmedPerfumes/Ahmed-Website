...
const translations = {
    en: {
        ...
        submit: "Send Inquiry",
        whatsapp: "WhatsApp for Corporate Orders",
        wa_text: "Hello, Please share your required quantity and gifting requirements to receive  a customized Quotation.",
...
// Paste your Google Apps Script Web App URL here (or set process.env.NEXT_PUBLIC_GOOGLE_SHEETS_URL)
const GOOGLE_SHEETS_URL = process.env.NEXT_PUBLIC_GOOGLE_SHEETS_URL || "https://script.google.com/macros/s/AKfycbyP8mKTidb7dgZY0a6R--1c21oZ6VS7DB4KZay2PlRJDkrkQ-NKSU1guZq-AxowL5IW/exec";
                        ...
                        >
                            ...
                            >
                                ...
                                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                                    <Box
                                        component="a"
                                        href={`https://wa.me/${CONTACT_WHATSAPP}?text=${encodeURIComponent(t.wa_text || 'Hello, I would like to place an order for customized corporate gifts from Ahmed Al Maghribi.')}`}
                                        target="_blank"
