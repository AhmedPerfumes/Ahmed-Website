...
const translations = {
    ...
    ar: {
        eyebrow: "تعاونات منتقاة بعناية",
        title: "مجموعات شركائنا المميزة",
        cta: "كن شريكاً لنا",
        slides: [
            {
                id: "airline",
                title: "مجموعة السفر",
                badge: "لكل رحلة",
                eyebrow: "حيث تتحول الرحلات إلى ذكريات",
                subtitle: "صُممت مجموعة السفر من أحمد المغربي خصيصاً لشركات الطيران والفنادق الفاخرة وشركات السفر وشركاء الضيافة، لترتقي بكل رحلة بلمسات من الأناقة والراحة وعبير لا يُنسى.",
                image: "/assets/Corporate Gift Sets/Airlines.jpeg",
                icon: <FlightTakeoffIcon sx={{ fontSize: "1.2rem", color: "#A88132" }} />,
                poem: "حلّق برقي، وصل بأناقة، واحمل عبيراً في كل ميل. من السماء إلى الشاطئ، ومن الفجر حتى الليل، رائحة تضفي الإشراق على كل رحلة.",
            },
            {
                id: "hajj-umrah",
                title: "مجموعة الحج والعمرة",
                badge: "لرحلتك المقدسة",
                eyebrow: "حيث يلتقي الإيمان بالسكينة",
                subtitle: "رحلة إيمان. هدية من البركات. تضم عطورنا المميزة وأدهان العود الفاخرة، مقدمة بأناقة في علب هدايا مصممة خصيصاً، لتكون تذكاراً ذا معنى للحجاج والأحبّة والضيوف.",
                image: "/assets/Corporate Gift Sets/corporate gift set beige color.jpg.jpeg",
                icon: <MosqueIcon sx={{ fontSize: "1.2rem", color: "#A88132" }} />,
                poem: "من نور مكة إلى رحاب المدينة، عسى السلام والرحمة أن يحتضنا قلبك. ومع كل عبير تبقى الذكريات، وتُعاش الرحلة المقدسة من جديد.",
            },
            {
                id: "bank",
                title: "تحالفات الشركات",
                badge: "لشراكاتنا القيّمة",
                eyebrow: "حيث تبني الثقة إرثاً",
                subtitle: "هدايا راقية لقطاعات البنوك والعقارات والسيارات. تُنتقى كل مجموعة بعناية لتكريم العملاء الكرام والشركاء الموثوقين والقادة أصحاب الرؤية، فتحوّل كل هدية إلى تعبير راقٍ عن التقدير والتميّز.",
                image: "/assets/Corporate Gift Sets/Banking.jpeg",
                icon: <AccountBalanceIcon sx={{ fontSize: "1.2rem", color: "#A88132" }} />,
                poem: "حيث تُبنى الثقة ويزدهر الإرث، يتحدث العطر بما تعجز الكلمات عن قوله. هدية من الهيبة، ورابطة من ذهب، وقصة تميّز لم تُروَ بعد.",
            },
        ],
    },
};
        ...
        >
            ...
            <Container maxWidth="xl" sx={{ position: "relative", zIndex: 1 }}>
                <Box sx={{ textAlign: "center", mb: { xs: 3, md: 6 } }}>
                    ...
                    >
                        {t.title || (isRtl ? "مجموعات شركائنا المميزة" : "Signature Partner Collections")}
                    </Typography>
