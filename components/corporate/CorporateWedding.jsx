...
const translations = {
    ...
    ar: {
        eyebrow: "الزفاف",
        badge: "ليومك المميز",
        subtitle_top: "حيث تزهر كل رابطة حب إلى الأبد",
        title: "مجموعتنا المخصصة للأعراس",
        p1: "كل رابطة تُعقد بالحب. كل وعد يُغلف بالثقة. وكل زفاف هو بداية لأبدٍ جميل.",
        p2: "احتفل بيومك المميز مع مجموعة الأعراس المخصصة من أحمد المغربي، وهي أطقم هدايا عطرية فاخرة صُممت لتجعل كل لحظة لا تُنسى وكل احتفال يزهر بالأناقة.",
        poem: "قلبان، روح واحدة، ودرب جميل،\nمعاً إلى الأبد من هذا اليوم المميز.\nعهدٌ من الحب، وحلمٌ يتحقق،\nوحياةٌ تبدأ بـ«أنا وأنت».",
        cta: "اطلب استشارة",
    }
};
