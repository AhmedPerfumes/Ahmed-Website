...
const translations = {
    ...
    ar: {
        label: "عملية بسيطة وسلسة",
        title: "كيف نعمل معك",
        steps: [
            {
                number: "٠١",
                title: "الاستشارة المبدئية",
                desc: "نبدأ بفهم هوية شركتك، جمهورك المستهدف، ميزانيتك، والمناسبة الخاصة بك.",
            },
            {
                number: "٠٢",
                title: "التنسيق والعينات",
                desc: "يقوم خبراؤنا بتنسيق أطقم العطور المناسبة وتقديم عينات لمراجعتك والموافقة عليها.",
            },
            {
                number: "٠٣",
                title: "التخصيص والتصميم",
                desc: "نقوم بإضافة شعارك، رسائلك الخاصة، وتغليفك المخصص بأعلى معايير الجودة.",
            },
            {
                number: "٠٤",
                title: "التسليم السلس",
