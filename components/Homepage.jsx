      ...
      <section className="scroll-section">
        <div className="panel section-1 w-100 vh-100">
          <div className="position-absolute px-5">
            <div className="text-center text-white ">SIGNATURE SELECTIONS</div>
            <h2 className="text-center text-white ">
              Fragrances Adored by All
            </h2>
            <p className="text-center text-white">
              Discover our bestsellers, crafted to suit diverse tastes. From
              classics to modern blends, each fragrance offers something unique
              for every scent lover.
            </p>
          </div>
          <a
            href=""
